...
async function check(url,expected,workerMode=false,ios=false){
 ...
 try{
  ...
  Object.defineProperties(video,{readyState:{value:4},videoWidth:{value:ios?480:640},videoHeight:{value:ios?640:480}});
  ...
  if(!workerMode||workerMode==='failed'||ios)widget.querySelector('[data-g=stop]').click();assert.equal(stopped,1);
