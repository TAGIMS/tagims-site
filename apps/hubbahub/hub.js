...
function applyFDColors(root){root.dataset.fdLabels='true';root.dataset.fdFancy='false';for(const key of [...root.style])if(key.startsWith('--fd-c-')||key.startsWith('--fd-s-'))root.style.removeProperty(key);}
