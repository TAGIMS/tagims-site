...
function redraw(){document.querySelectorAll('.fd-root').forEach(e=>{let y=e.querySelector('.fd-scroll')?.scrollTop||0;e.innerHTML=render();e.querySelector('.fd-scroll').scrollTop=y;});refresh();}
